...
//  FoodTracker
//
//  Created by Nam Jose on 7/19/20.
...
class MealTableViewController: UITableViewController {
    ...
    */
    ...
    private func saveMeals() {
        do {
            let codedData = try NSKeyedArchiver.archivedData(withRootObject: meals, requiringSecureCoding: false)
            try codedData.write(to: Meal.ArchiveURL)
        } catch {
